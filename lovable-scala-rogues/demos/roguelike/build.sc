...
object myroguelike extends ScalaJSModule with MillIndigo {
  ...
  val indigoOptions: IndigoOptions =
    IndigoOptions.defaults
      .withTitle("My Roguelike")
      .withWindowSize(16 * 10 * 3, 16 * 10 * 3)
  ...
  def ivyDeps =
    Agg(
      ...
      ivy"io.indigoengine::roguelike-starterkit::0.5.0"
    )
...
object myroguelikecomplete extends ScalaJSModule with MillIndigo {
  def scalaVersion   = "3.3.1"
  def scalaJSVersion = "1.15.0"
